# hydroi_mpfa.mak - Implicit hydrology make include file
...
harray.f: $(SORC)harray.df control.h harydat.h msjunk.h blkary.h earydat.h
	$(SETSIZE1)
	$(SIZEIT)
...
hbdary.f: $(SORC)hbdary.df boundary.h rock.h hfluids.h control.h 
	$(SETSIZE1)
	$(SIZEIT)
# sgt
