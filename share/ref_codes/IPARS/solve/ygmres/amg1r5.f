...
C
C 1.  A BUG IN SUBROUTINE CHECKMG HAS BEEN REMOVED. IF THE ORIGINAL MATRIX
...
C     STATEMENTS IN SUBROUTINE CHECKMG HAVE BEEN CHANGED:
C
...
C
      IMIN(1) = 1
      IMAX(1) = NNU
      CALL CHECKMG(IERR,A,IA,JA,IMIN,IMAX,ICG,IFG,TIME,ISYM,IROW0,NDA,
     +           NDICG,NDJA,IUM)
      IF (IERR.GT.0) RETURN
C
...
C.......................................................................
C
C     CHECKMG                                               SUBROUTINE
C
C.......................................................................
C
      SUBROUTINE CHECKMG(IERR,A,IA,JA,IMIN,IMAX,ICG,IFG,TIME,ISYM,IROW0,
     +                 NDA,NDICG,NDJA,IUM)
C
...
C===> MESSAGES ON A
C
c     IF (ASYM.EQ.0.0D0) WRITE (IUM,9000)
c     IF (ASYM.NE.0.0D0) WRITE (IUM,9005) ASYM
c     IF (NAOFF.GT.0)    WRITE (IUM,9010) NAOFF
c     IF (NANEG.GT.0)    WRITE (IUM,9020) NANEG
c     IF (NAZER.EQ.NNU)  WRITE (IUM,9025)
c     IF (NAOFF.EQ.0 .AND. NANEG.EQ.0) WRITE (IUM,9030)
C
C===> WARNINGS
C
...
170   IF (IOUT.NE.3.AND.IOUT.NE.0) CALL RESID(1,RES,A,U,F,IA,JA,IW,
     +                                        IMIN,IMAX,IMINW)
      RETURN
C
9000  FORMAT (' CYCLE  0:',3X,'RES=',D10.3)
9005  FORMAT (/' ************* CYCLING..... *************'/)
9010  FORMAT ( ' CYCLE ',I2,':   RESCG=',D10.3,'   RES=',D10.3,
     +         '   CFAC=',D10.3)
9020  FORMAT ( ' CYCLE ',I2,':   RES=',D10.3,'   CFAC=',D10.3)
9030  FORMAT (' --------------------------------------------------',
     +        '----------')
...
C.......................................................................
C
C     YV_RANDOM                                                FUNCTION
C
C.......................................................................
C
      DOUBLE PRECISION FUNCTION YV_RANDOM(S)
C
...
C
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      SAVE
      YV_RANDOM=100.0D0*DEXP(S)
      YV_RANDOM=YV_RANDOM-DBLE(INT(YV_RANDOM))
      S=YV_RANDOM
      RETURN
      END
c***********************************************************************
