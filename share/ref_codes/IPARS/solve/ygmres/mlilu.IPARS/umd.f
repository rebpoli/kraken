...
C  compatible with the Harwell Subroutine Library.
        ...
        RETURN
        END 
        SUBROUTINE UMD2FA (N, NE, JOB, LVALUE, LINDEX, VALUE,
c       SUBROUTINE UMD2FA (N, NE, JOB, TRANSA, LVALUE, LINDEX, VALUE,
...
9000    CONTINUE
     ...
     $          IGNORE, IGNORE, 1, IGNORE, 1)
        RETURN
        END 
c       SUBROUTINE UMD2SO (N, JOB, TRANSC, LVALUE, LINDEX, VALUE,
        SUBROUTINE UMD2SO (N, JOB, LVALUE, LINDEX, VALUE,
...
9000    CONTINUE
     ...
     $          B, X, N, W, LW)
        RETURN
        END 
c       SUBROUTINE UMD2RF (N, NE, JOB, TRANSA, LVALUE, LINDEX, VALUE,
        SUBROUTINE UMD2RF (N, NE, JOB, LVALUE, LINDEX, VALUE,
     $          INDEX, KEEP, CNTL, ICNTL, INFO, RINFO)
        INTEGER N, NE, JOB, LVALUE, LINDEX, INDEX (LINDEX), KEEP (20),
     $          ICNTL (20), INFO (40)
        DOUBLE PRECISION
