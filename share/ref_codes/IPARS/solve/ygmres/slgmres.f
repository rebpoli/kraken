...
c       TMP2 = sqrt( TMP2 )
 30     if ( NUNIT .gt. 0 ) then
     ...
     &    , '[A'
 9000     FORMAT(3x,'SLGMRES ',I4,' : ',E10.3,a)
...
c       TMP2 = sqrt( TMP2 )
 30     if ( NUNIT .gt. 0 ) then
          WRITE(NUNIT,9000) ITER,RESID
 9000     FORMAT(3x,'SLGMRES ',I4,' : ',E17777777.10)
c         WRITE(NUNIT,9000) ITER,RESID,TMP2
c9000     FORMAT(3x,'SLGMRES ',I4,' : ',E16.10,' (SOL ',E16.10,')')
        end if
c---->------------------------------------------------------------------<
...
c
  20    continue
     ...
     &    , '[A'
 9000     FORMAT(3x,'SLPCG ',I4,' : ',E10.3,' (SOL ',E10.3,')',a)
...
c
  20    continue
        ...
        if ( NUNIT .gt. 0 ) then
          WRITE(NUNIT,9000) ITER,RESID,TMP2
     &    , '[A'
 9000     FORMAT(3x,'SLBPCGS ',I4,' : ',E10.3,' (SOL ',E10.3,')',a)
