...
C --- SAUMIK,BGANIS
      REAL*8  MIDPOINTS(10,2,2562,2562)
C     &       ,POINT(MXINTPOINT,3),
C     &       VOL1(MXINTBIG,MXINTSMALL),VOL2(MXINTBIG,MXINTSMALL)

      INTEGER N_PORTRUE,N_RC,
     &        NEW_COMM,NEW_RANK,FLOW_COMM(10),
     &        NPAY,START1,GLOBAL
C     &       ,VAL1(MXELEM),
C     &        VAL2(MXINTBIG,MXINTSMALL),
C     &        VAL3(MXELEM),
C     &        VAL4(MXINTBIG,MXINTSMALL),
C     &        SKIP(MXELEM),INFLAG(MXELEM)

      LOGICAL FLAGBLK(10),NONMATCHING

      COMMON /BLKARY2/MIDPOINTS,
C     &   POINT,VOL1,VOL2,
     &   N_PORTRUE,N_RC,
     &   NEW_COMM,NEW_RANK,FLOW_COMM,
     &   NPAY,START1,GLOBAL,FLAGBLK,NONMATCHING
C     &   ,VAL1,VAL2,VAL3,VAL4,SKIP,INFLAG
