C  LAYOUT.H - MEMORY MANAGEMENT AND PARALLEL DATA
     ...
     & XREC(4,10),
     & YREC(2563,10), ZREC(2563,10),CONV_FACTOR,
     & PRCMAP(65600000), NUMBLK,ILAY,JLAY,KLAY,MAXREF,NUMTMP,NUMMODEL,
     & MSGS(4,10),MODPROC(19,256),NEMOD(19),
     & MSGTRG(10,4,10),
     & MSGSRC(10,4,10),LSTIND,MSGSNDF(10,4,10),
     & MSGSNDL(10,4,10),MSGRCVF(10,4,10),
     & MSGRCVL(10,4,10),MSGIND(2,2000),N0MAP(10),
     & NYMAP(10),KNDGRD,METHOD,EV_PRCBLK,NETOTR0,NETOTR(19),
     & MYBLK(10),
     & DXREC(3,10),DYREC(2562,10),
     & DZREC(2562,10),XYZ111(3,10),
     & MFMFE_BRICKS,PLOT_MYPRC,DEALII,
     & DATASPACES,MPI_EXTERNAL,COMMI_DONE

CBW EXTENTION TO NODAL BASED COMMUNICATION
      INTEGER PRCMAPN, N0MAPN
      COMMON /LAYOUTN/ PRCMAPN(2*65600000), N0MAPN(10)
CBW
