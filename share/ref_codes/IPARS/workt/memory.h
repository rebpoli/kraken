...
#define MAXPRC   256    // Maximum number of processors
#define MAXBNAM  60    // Maximum block name length
#define MAXARY   200    // Maximum number of arrays
#define MAXANAM  10    // Maximum array name length
#define MAXARG   200    // Maximum total number of work routine arguments
