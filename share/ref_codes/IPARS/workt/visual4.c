...
#define Point2 GPoint2[slice]
    ...
    Point1.i=find_ind(Point1.x,vis_xrec,vis_dxrec,0,(4)-1);
    Point1.j=find_ind(Point1.y,vis_yrec,vis_dyrec,0,(2563)-1);
    Point1.k=find_ind(Point1.z,vis_zrec,vis_dzrec,0,(2563)-1);
    /**
    ...
    **/
    ...
    Point2.i=find_ind(Point2.x,vis_xrec,vis_dxrec,0,(4)-1);
    Point2.j=find_ind(Point2.y,vis_yrec,vis_dyrec,0,(2563)-1);
    Point2.k=find_ind(Point2.z,vis_zrec,vis_dzrec,0,(2563)-1);
    /**
